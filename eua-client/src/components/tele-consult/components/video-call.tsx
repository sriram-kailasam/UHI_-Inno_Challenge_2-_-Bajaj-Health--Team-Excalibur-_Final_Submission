...
const VideoCall: FC<Props> = () => {
    ...
    function createRTCPeerConnection() {
        ...
        (connection.current as any).onicecandidate = (event: any) => {
            if (event.candidate) {
                console.log(
                    "Sending Ice Candidate - " + event.candidate.candidate
                );
        ...
        (connection.current as any).onconnectionstatechange = function (
            ...
            switch ((connection.current as any).connectionState) {
                case "connected":
                    ...
                    (document.getElementById("answerButton") as any).disabled =
                        true;
                    (
                        document.getElementById("sendOfferButton") as any
                    ).disabled = true;
                    (document.getElementById("hangUpButton") as any).disabled =
                        false;
                    (
                        document.getElementById("sendMessageButton") as any
                    ).disabled = false;
                    break;
                case "disconnected":
                    console.log(
    ...
    const handleCandidate = (candidate: any) => {
        ...
        (connection.current as any).addIceCandidate(
