            ...
            className={clsx(
                {
                    ...
                    'border-green-500 hover:bg-green-500 active:bg-green-500 focus:bg-green-500 focus:outline-none focus:ring-0 focus: ': outline && variant === 'primary',
                ...
                'rounded font-medium whitespace-nowrap cursor-pointer font-display duration-200 ease-out disabled:bg-[#626262] shadow-sm  active:scale-95  outline-none',
                className
            )}
            disabled={loading}
            {...rest}>
